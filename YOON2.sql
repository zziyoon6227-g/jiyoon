...
AS SELECT * FROM DEPT; --여기서 AS는 별칭이 아니고 DEPT내용을 가져와서 테이블 만들겠다
...
INSERT INTO EMP_TEMP (EMPNO, ENAME, JOB, MGR, HIREDATE, SAL, COMM, DEPTNO)
VALUES (2111, '이순신', 'MANAGER', 9999, '2001-08-09', 4000, NULL, 20);
...
UPDATE DEPT_TEMP2
SET DNAME = 'DATABASE1', LOC = 'SEOUL'
WHERE DEPTNO = 30;
ROLLBACK; --되돌리기 기능
SELECT * FROM DEPT_TEMP2; --테이블 조회
